...
def write_predictions_csv(
    ...
    *,
    ...
    for sample_id, row in zip(ids_list, preds):
        # Preserve the sample ID in the first column.
...
def export_artifacts(
    ...
    *,
    ...
    feature_transformer: object | None,
) -> Path:
    """
    Save model weights and preprocessing artifacts in a single file.
    """
    path = ensure_parent_dir(path)
    # Store tensors on CPU for portable loading later.
    payload = {
