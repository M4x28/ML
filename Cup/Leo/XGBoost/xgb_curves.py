...
def build_curves(
    *,
    ...
    """Train models for different n_estimators and collect metrics."""
    ...
    for n_estimators in curve_iters:
        # Refit the model for each estimator budget.
...
def build_curves_per_target(
    *,
    ...
    """Train one model per target and collect curves over n_estimators."""
    train_mse: list[float] = []
    test_mse: list[float] = []
    train_mee: list[float] = []
    test_mee: list[float] = []
