...
def _l2_penalty(model: torch.nn.Module) -> torch.Tensor:
    ...
    for name, param in model.named_parameters():
        ...
        if name.endswith("bias"):
            continue
        # Sum squared weights for L2 penalty.
...
def evaluate_regression_metrics(
    ...
    *,
    ...
    """Evaluate MSE/MEE and loss (MSE + optional L2 penalty)."""
    ...
    for batch in dataloader:
        ...
        # Accumulate Euclidean errors for MEE.
    ...
    # Keep loss aligned with training objective.
